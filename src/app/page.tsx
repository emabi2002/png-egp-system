    ...
    <div className="space-y-2">
      ...
      <section className="text-center space-y-3 py-4">
        <div className="space-y-3">
          <div className="flex justify-center">
            <PNGLogo size="xl" className="drop-shadow-lg" />
          </div>
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-red-600 to-yellow-600 bg-clip-text text-transparent">
        ...
        <div className="flex flex-col sm:flex-row gap-2 justify-center">
          <Link href="/tenders">
            <Button size="default" className="bg-red-600 hover:bg-red-700">
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-3">
        <Card>
          ...
          <CardContent>
            <div className="text-xl font-bold">{mockStats.openTenders}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl font-bold">{mockStats.totalSuppliers}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl font-bold">{mockStats.recentAwards}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl font-bold">{mockStats.totalSpend}</div>
      ...
      <section className="space-y-3">
        <div className="flex justify-between items-center">
          <h2 className="text-xl font-bold">Recent Tenders</h2>
          <Link href="/tenders">
              ...
              <CardHeader>
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <div className="text-xl font-bold text-green-600">{tender.value}</div>
      ...
      {/* Call to Action */}
      <section className="bg-gradient-to-r from-red-600 to-yellow-600 rounded-lg p-4 text-center text-white">
        <div className="space-y-2">
          ...
          <div className="flex flex-col sm:flex-row gap-2 justify-center">
            ...
            <Link href="/help">
              <Button size="default" variant="outline" className="text-white border-white hover:bg-white hover:text-red-600">
                Learn More
              </Button>
            </Link>
          </div>
